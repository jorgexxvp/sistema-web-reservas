            ...
            <ColumnsTable
              ...
              onClick={() => {
                ...
                formUser.setValues({
                  ...
                  documento: userDetails?.correo,
                  telefono: userDetails?.telefono,
                  rolId: userDetails?.usuarioId,

                  // usuario: userDetails?.usuario,
                  // estadoCodigo: userDetails?.estadoCodigo,
                  // fechaNacimiento: userDetails?.fechaNacimiento,
                });
              }}
            />
          </tr>
      ...
      {openModal && (
        ...
        >
          <form
            ...
            onSubmit={handleSubmit((data) => fetchCreateUser(data))}
          >
